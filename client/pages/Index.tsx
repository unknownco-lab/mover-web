      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-purple-50 to-white pt-20 pb-32 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Mover is a lightweight, intelligent application that keeps your system active with natural, configurable movement patterns. Perfect for presentations, long work sessions, or when you need your PC to stay responsive.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="mailto:support@mover.app" className="hover:text-purple-400 transition">Email Support</a></li>
