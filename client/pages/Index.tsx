          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Mover is built with privacy as a core principle. We don't collect any data about how you use the application.
              </p>
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Mover doesn't track your usage, mouse movements, or any activity. Your privacy is completely protected.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      After installation, Mover works completely offline. No internet connection required for normal operation.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      All processing happens locally on your device. No data is transmitted to remote servers.
                    </p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-12 border border-purple-200">
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Mover does not collect, store, or transmit any personal data, usage metrics, or activity logs. Your activity remains entirely private.
                  </p>
                </div>
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <p className="text-sm font-semibold text-purple-600 mb-2">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    We do not use analytics, telemetry, or tracking software. Optional crash reporting (if enabled) contains no personal information.
                  </p>
                </div>
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <p className="text-sm font-semibold text-purple-600 mb-2">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Mover integrates no third-party tracking, advertising, or analytics libraries.
                  </p>
                </div>
              </div>
            </div>
